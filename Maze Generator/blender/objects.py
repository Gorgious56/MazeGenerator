...
def update_wall_visibility(props, is_algo_weaved) -> None:
    ...
    obj_walls.hide_viewport = obj_walls.hide_render = \
...
class ObjectsPropertyGroup(bpy.types.PropertyGroup):
    ...
    cells: bpy.props.PointerProperty(
        name="Cells Object",
        type=bpy.types.Object)
    cylinder: bpy.props.PointerProperty(
        name="Cylinder Object",
        type=bpy.types.Object)
    torus: bpy.props.PointerProperty(
        name="Torus Object",
        type=bpy.types.Object)
    thickness_shrinkwrap: bpy.props.PointerProperty(
        name="Empty Object helping shrinkwrapping",
        type=bpy.types.Object)
